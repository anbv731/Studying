...
fun main() {
    ...
    println(
        customer3.getOrderedProducts() == setOf(
            product1,
            product3,
            product4,
            product6,
    ...
    println(
        shop.groupCustomersByCity() == mapOf(
            city1.title to setOf(customer1),
            city2.title to setOf(customer2),
            city3.title to setOf(customer3)
        )
    )
